...
public class QrMainActivity extends AppCompatActivity implements Scene.OnUpdateListener {
    ...
    public void onUpdate(FrameTime frameTime) {
        ...
        Toast.makeText(getApplicationContext(), Boolean.toString(isPopedUP), Toast.LENGTH_SHORT).show();
                ...
                if (augmentedImage.getTrackingState() == TrackingState.TRACKING) {
                    switch (augmentedImage.getName()) {
                        case "ambs":
                                ...
                                customPopUP.setTitle("Test");
                                customPopUP.setSubtitle("bureau de M.Ambs");
                                customPopUP.setOnDismissListener(this::onDismiss);
                                customPopUP.getReturnButton().setOnClickListener(v -> customPopUP.dismiss());
                                customPopUP.build();
                            break;
